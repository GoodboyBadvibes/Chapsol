  ...
  return (
    ...
    <main className=" section " > {/**/}
      ...
      <div className=" py-5 sm:py-28 "> {/* There existed a general padding here before the product designer brought up some sort of annoying upgarde which resulted in removing general padding and instead giving the standard padding to each component on this page... the padding is a set of tailwind classes : " px-5 sm:px-10 md:px-20 "*/}
        ...
        <div className={' block sm:flex items-start justify-between px-5 sm:px-10 md:px-20 pb-5 sm:pb-32 pt-48 bg-standard'} style={{color: 'white'}}>
         ...
         <div className=" px-5 sm:px-10 md:px-20 "  data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500">
          <h1 className={style.header+" pb-5 sm:pb-11 pt-40"}>Our Products</h1>
