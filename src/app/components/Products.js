    ...
    <div className="px-5 sm:px-10  md:px-20 " id='products'>
      ...
      <div className={" sm:flex justify-between gap-20 sm:p-11 transition-all duration-1000"}>
        ...
        <div className={' gap-0 sm:w-1/2 mx-auto pb-16 '+ style.btnDiv}>
          ...
          <div className={style.btn +' '+(product==='OVS'?style.btnClick:style.btnUnclick)} onClick={()=>{setProduct("OVS");changeProduct()}}>
             <h1>OVS Studio</h1>
          </div>

          <div className={style.btn +' '+(product==='campaign'?style.btnClick:style.btnUnclick)} onClick={()=>{setProduct("campaign");changeProduct()}}>
             <h1>Campaign</h1>
          </div>

          <div className={style.btn  +' '+(product==='community'?style.btnClick:style.btnUnclick)} onClick={()=>{setProduct("community");changeProduct()}}>
